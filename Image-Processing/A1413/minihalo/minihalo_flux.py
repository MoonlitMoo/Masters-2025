...
# --- Data ---
mh_freq = np.array([0.145, 1.283, 10])
mh_flux = np.array([29.5, 3.23, 0.404])
mh_err  = np.array([3.4, 0.17, 0.0412])

bcg_freq = np.array([0.145, 0.4, 0.675, 1.283, 1.519])
bcg_flux = np.array([3.78, 1.2, 0.63, 0.3, 0.27])
bcg_err  = np.array([0.75, 0.14, 0.05, 0.02, 0.02])
